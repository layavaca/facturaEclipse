...
a persistence unit "facturacionPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "facturacion/pom.xml":
...
artifact ("facturacion.war") is already built. You can build
